 ...
 */
@WebServlet(name = "ModificarEstadoController", urlPatterns = {"/modificarEstadoController"})
public class ModificarEstadoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btnEdit") !=null) {
                daoInvest.modificarEstadoInvestigacion(estado,id);
                response.sendRedirect("Admin/estadoInvestigacionesAdmin.jsp?id="+estadoAnterior);
            } 
            rd = request.getRequestDispatcher("Admin/cambiarEstado.jsp?id="+estadoAnterior);
