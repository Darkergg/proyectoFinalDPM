 ...
 */
@WebServlet(name = "InvestigacionSuperInvestigacionController", urlPatterns = {"/investigacionSuperInvestigacionController"})
public class investigacionSuperInvestigacionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btnEdit") != null) {
                ...
                response.sendRedirect("SuperAdministrador/investigacionesSuperAdmin.jsp");
            } else if (request.getParameter("btnDelete") != null) {
                daoInvest.eliminarInvestigacion(invest);
                response.sendRedirect("SuperAdministrador/investigacionesSuperAdmin.jsp");
            }
            rd = request.getRequestDispatcher("SuperAdministrador/agregarInvestigacion.jsp");
        } catch (Exception e) {
        }
    }
