 ...
 */
@WebServlet(name = "AgregarInvestigacionController", urlPatterns = {"/agregarInvestigacionController"})
public class agregarInvestigacionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String[] nombres = request.getParameterValues("tags");
            ...
            if (request.getParameter("btnAdd") != null) {
                ...
                daoInvest.insertarInvestigacion(invest);
                daoInvest.insertDetalleInvesTags(nombres);
                response.sendRedirect("Investigador/agregarInvestigacion.jsp");
            ...
            rd = request.getRequestDispatcher("Investigador/agregarInvestigacion.jsp");
        } catch (Exception e) {
        }
    }
