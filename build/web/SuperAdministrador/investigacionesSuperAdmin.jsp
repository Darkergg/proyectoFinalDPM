    ...
    <body style="background: #980081;">
        ...
        <section>
            <div class="body">
                <div class="container">
                    <%-- eliminar --%> 
                    <form action="../investigacionSuperInvestigacionController" method="POST" style="display: none;"  name="frmEliminar" id="frmEliminar">
                    ...
                    <div class="row align-items-start">
                        <%
                            List<Investigacion> lista = daoInvest.getInvestigacion();
                            for (Investigacion invest : lista) {
                        %>
                        <div class=" col-auto me-auto m-3">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="m-1 p-0">
                                            <a href="vistaInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" class="btn col-auto btn-primary"><i class="bi bi-view-list"></i> Ver </a>
                                            ...
                                            <a href="editarInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" class="btn col-auto btn-primary "><i class="bi bi-pencil-square"></i> Editar</a>                                
