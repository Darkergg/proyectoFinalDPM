            ...
            <div class="body">
                <div class="container">
                    <div class="row align-items-start">
                        <%
                            List<Investigacion> lista = daoInvest.investigacionRecientes();
                        ...
                        <div class=" col-auto me-auto m-3">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="vistaInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" class="btn btn-primary"> Ver investigación </a>
                                </div>
                            </div>
