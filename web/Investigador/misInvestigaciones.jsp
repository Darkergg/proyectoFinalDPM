                        ...
                        <div class=" col-auto me-auto m-3">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="m-1 p-0">
                                            <a href="../SuperAdministrador/vistaInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" class="btn col-auto btn-primary"><i class="bi bi-view-list"></i> Ver </a>
                                            ...
                                            <a href="../SuperAdministrador/editarInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" class="btn col-auto btn-primary "><i class="bi bi-pencil-square"></i> Editar</a>                                
