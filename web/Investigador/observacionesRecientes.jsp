                            ...
                            <div class="card styled-dialog" >
                                <div class="card-header" style="background-color: #1cb2e2">
                                    <div class="d-flex justify-content-between " >
                                        <div class="text-center w-100"><h1 class="text-center">Ultimas observaciones</h1></div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="styled-table table-responsive-xl w-100" id="tabla">
                                        ...
                                        <tbody>
                                            <%
                                                List<Observaciones> list = daoObs.observacionReciente();

                                                for (Observaciones obs : list) {
                                                ...
                                                <td p-0 pt-2 px-0">
                                                    <div class="row m-0 justify-content-center justify-content-md-start px-0">
                                                        <div class="col-auto w-100">
                                                            <a href="javascript:cargar(<%=obs.getIdObervacion()%>,'<%=obs.getContObservacion()%>')" data-toggle="tooltip" title="Eliminar" data-placement="bottom" id='btnBorrar'><span class="material-symbols-outlined btn btn-danger mt-1" onclick="eliminar();">Delete</span></a>
                                                            ...
                                                            <a href="javascript:cargar(<%=obs.getIdObervacion()%>,'<%=obs.getContObservacion()%>')" data-toggle="tooltip" title="Editar" data-placement="bottom" onclick="$('#frmTag').show();
                                                                    $('#frmActuTag').show();
                                                                    $('#btnEditar').show();
                                                                    $('#btnEditar').focus();"><span class="material-symbols-outlined btn btn-warning mt-1">Editar</span></a> 

                                                            <a href="vistaInvestigacion.jsp?id=<%=invest.getIdInvestigacion()%>" data-toggle="tooltip" title="Vista" data-placement="bottom" id='btnVista'><span class="material-symbols-outlined btn btn-success mt-1" ">Ver investigación</span></a>
                                                        </div> 
                                                    </div>
                                                </td>
