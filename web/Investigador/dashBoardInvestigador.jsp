...
<html>
    ...
    <body style="background: #970182;" >
        ...
        <%
            ...
            DaoInvestigador daoInvestigador = new DaoInvestigador();
                            ...
                            <div class="card radius-10 border-start border-0 border-3 border-info">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <Strong class="mb-0 font-13">Mis investigaciones</Strong>
                                                <%                                                        List<Investigador> list1 = daoInvestigador.getCantidadInvestigador(Integer.parseInt(sesion.getAttribute("id").toString()));
                                                    for (Investigador invest : list1) {

                                                %>
                                            <h4 class="my-1 text-info"></h4>
                                            <p class="mb-0 font-13">Cantidad: <%= invest.getCantInvestigadores()%></p>
                                            <br>
                                        </div>
                                        <%
                                            }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <Strong class="mb-0 font-13">Mis investigaciones</Strong>
                                            <h4 class="my-1 text-info"></h4>
                                            <p class="mb-0 font-13">Nueva investigación  </p>
                                            <br>
                                        </div>
                                        <a href="agregarInvestigacion.jsp">
                                            <div class="widgets-icons-2 rounded-circle bg-gradient-scooter text-white ms-auto">
                                                <i class="bi bi-file-earmark-richtext"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="card radius-10 border-start border-0 border-3 border-info">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="estadoInvestigaciones.jsp?estado=3">
                            ...
                            <div class="card radius-10 border-start border-0 border-3 border-info">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="estadoInvestigaciones.jsp?estado=2">
                                            <div class="widgets-icons-2 rounded-circle bg-gradient-blooker  text-white ms-auto">
                                                <i class="bi bi-file-text"></i>
                                            </div>
                                        </a>
